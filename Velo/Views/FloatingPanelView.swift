...
final class FloatingPanel<Content: View>: NSPanel {
    ...
    override func center() {
        ...
        self.setFrameOrigin(NSPoint(x: (rect!.width-self.frame.size.width)/2, y: (rect!.height-self.frame.size.height)/2))
//        self.setFrameOrigin(NSPoint(x: rect!.width - self.frame.width, y: rect!.height - self.frame.height))
    }
